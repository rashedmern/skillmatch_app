...
export const HeroSection: React.FC = () => {
  return (
    <section className="relative w-full overflow-hidden bg-surface pt-6 pb-16 sm:pb-20 lg:pt-12 lg:pb-28">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[1440px] h-[640px] pointer-events-none -z-10 overflow-hidden">
        <div className="absolute -top-[180px] left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-[radial-gradient(ellipse_60%_50%_at_50%_20%,rgba(10,136,125,0.12),transparent_75%)]" />
        <div className="absolute top-[100px] right-[5%] w-[450px] h-[450px] bg-[radial-gradient(circle_at_center,rgba(9,89,100,0.08),transparent_70%)]" />
      </div>
